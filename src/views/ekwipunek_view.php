...
<body>
	<header>
		...
		<nav>
			<ol>
				...
				<li class="active"><a href="/ekwipunek">Wyposażenie</a></li>
	...
	<div class="container">
		<div class="content">
			<div class="pic_glown" id="pic_glown2"></div>
			...
			<article>
				<div class="wstep_str">
					<header>
						<h1>Specjalistyczny ekwipunek alpinistów</h1>
					</header>
					<div class="tresc">
						<h2 id="wyposazenie">Wyposażenie na wyprawę wspinaczkową</h2>
						<p>
							Ponieważ podczas wspinaczki znajdujesz się na różnych wysokościach, a przez to musisz znosić różne <b>warunki pogodowe</b>, to twoje <b>wyposażenie zawsze musi być dostosowane do trasy</b>. Ale pomimo tego staraj się, żeby twój bagaż był <b>możliwie jak najlżejszy i żeby zabierać tylko rzeczy najpotrzebniejsze</b>. Lekki, ergonomiczny plecak o dużej pojemności będzie na wyprawie wysokogórskiej idealnym narzędziem. Możliwa <b>lista wyposażenia na wyprawę alpinistyczną</b> mogłaby wyglądać na przykład tak:
						</p>
						<img id="pic3" src="static/img/pic3.jpg" alt="picture">
						<ul>
							<li>Buty górskie z cholewkami za kostkę i antypoślizgowym, przyczepnym bieżnikiem.</li>
							<li>Raki (zapewniają dobrą przyczepność również na rumowiskach)</li>
							<li>Ubranie na cebulkę (z bielizną termiczną i nieprzemakalną kurtką w zależności od planowanych wysokości)</li>
							<li>Dopasowany kask wspinaczkowy</li>
							<li>Latarka czołowa</li>
							<li>Rękawice i czapka</li>
							<li>Wystarczająca ilość prowiantu oraz wody</li>
							<li>Mapa, przewodniki, kompas</li>
							<li>Lina asekuracyjna</li>
							<li>Apteczka pierwszej pomocy zawierająca folię NRC i naładowany telefon komórkowy</li>
							<li>Ewentualnie: sprzęt wspinaczkowy i/lub wyposażenie na lodowce</li>
							<li>Ewentualnie: płachta biwakowa</li>
						</ul>
						<p>
							Na dużych wysokościach ważna jest odpowiednia ochrona przed słońcem, ponieważ promienie słoneczne odbijają się od śniegu oraz lodu, przez co intensywniej działają na skórę. Jeżeli planujesz wielodniową wyprawę, na twojej liście rzeczy do zabrania nie może zabraknąć <b>bielizny na zmianę</b>. Poza tym, podczas <b>noclegu w schronisku górskim</b> potrzebne ci będą: śpiwór, zestaw kosmetyków i mały ręcznik.
						</p>
					</div>
				</div>
			</article>
		...
		<div class="asid" id="asid">
					...
					<nav>
						<div class="nawigacja">
							<h2>Nawigacja</h2>
							<ul>
							<li><a id="nawwyp" href="#wyposazenie">Wyposażenie na wyprawę wspinaczkową</a></li>
							</ul>
						</div>
					</nav>
